...
var _user$project$Main$receiveSizeAndPos = _elm_lang$core$Native_Platform.incomingPort(
	'receiveSizeAndPos',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (winWidth) {
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$receiveSizeAndPos(_user$project$Main$ReceiveDataFromJS);
};
